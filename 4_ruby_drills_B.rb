...
# 27. Define a class that has three attributes. Set one of those attributes at the time objects are initialised. Make one attribute readable, and the other two writeable.
# 28. Make two instance methods in the class you defined that do something basic (anything you like).
...
# 38. Define a variable that will be assigned an empty array.
# 39. Define a method that takes an array and a hash as arguments. The function will push the hash into the array given.
# 40. Using the method, the four hashes, and the array that you have made in the previous steps, call the method four times to put those four hashes into the array.
...
# 58. Make seven objects from this class.
# 59. Make four variables: a hash, an array, an integer, and boolean.
# 60. Assign these variables to attributes from the various objects you made. 
# 61. Puts to screen two attributes from four different objects.
...
# 72. Make seven objects from this class.
# 73. Make four variables: a hash, an array, an integer, and boolean.
# 74. Assign these variables to attributes from the various objects you made.
# 75. Puts to screen two attributes from four different objects.
# 76. Call two instance methods on four different objects.